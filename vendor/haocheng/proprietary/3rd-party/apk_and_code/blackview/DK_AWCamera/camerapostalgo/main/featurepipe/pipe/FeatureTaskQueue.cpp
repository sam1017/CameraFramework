...
FeatureTaskQueue::FeatureTaskQueue(MUINT8 max)
    : mStop(MFALSE)
    , mThreadMax(max)
    , mThreadCount(0)
{
...
FeatureTaskQueue::~FeatureTaskQueue()
{
    mStop = MTRUE;
 ...
 MVOID FeatureTaskQueue::addTask(std::function<void()>& func)
{
...
MVOID FeatureTaskQueue::addThread() {
