...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_UTILS_GRALLOC_IGRALLOCHELPER_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_UTILS_GRALLOC_IGRALLOCHELPER_H_
//
...
public:     ////                Interfaces.
    ...
    /**
     * Set a given timestamp of start of frame to the image buffer.
     */
    ...
    /**
     * Given a dataspace, return a String8 name.
     */
    virtual String8             queryDataspaceName(int32_t dataspace) const  = 0;
    ...
    /**
     * Import buffer handle w/ gralloc I/F.
     */
    // virtual bool                importBuffer(buffer_handle_t& handle)       = 0;

    /**
     * Free buffer handle w/ gralloc I/F.
     */
    // virtual void                freeBuffer(buffer_handle_t handle)          = 0;

    /**
     * Use Mapper lock/unlock w/ gralloc I/F.
     */
    virtual int                 lock(
 ...
 *
 ******************************************************************************/
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_UTILS_GRALLOC_IGRALLOCHELPER_H_
