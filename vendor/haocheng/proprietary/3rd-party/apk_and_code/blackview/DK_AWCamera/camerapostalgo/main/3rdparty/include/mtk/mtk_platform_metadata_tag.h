...
typedef enum mtk_platform_metadata_tag {
    ...
    MTK_POSTALGO_VENDOR_FACE_BEAUTY_FACEORIENTATION,           //Postalgo
    ...
    MTK_POSTALGO_AI_COMBO_TYPE,
    MTK_POSTALGO_AI_COMBO_BIGEYE,
    MTK_POSTALGO_AI_COMBO_SMALLCHEEK,
    MTK_POSTALGO_AI_COMBO_SMOOTH,
    MTK_POSTALGO_AI_COMBO_WHITE,
...
typedef enum ai_combo_type_metadata_enum {
    AI_COMBO_NO_EFFECT      = 0,
    AI_COMBO_BOKEH          = 1 << 0,
    AI_COMBO_COLOR          = 1 << 1,
    AI_COMBO_SLIMMING       = 1 << 2,
    AI_COMBO_LEGGY          = 1 << 3,
} ai_combo_type_metadata_enum;
