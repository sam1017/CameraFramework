...
MBOOL YUVNode::onInit()
{
    ...
    for (auto& pProvider : vSortedProvider) {
        ...
        else if (rProperty.mFeatures & MTK_FEATURE_AI_COMBO_PREVIEW)
            featId = FID_AI_COMBO_PREVIEW;
        else if (rProperty.mFeatures & MTK_FEATURE_AI_COMBO_CAPTURE)
            featId = FID_AI_COMBO_CAPTURE;
        else if (rProperty.mFeatures & MTK_FEATURE_AI_COMBO_VIDEO)
            featId = FID_AI_COMBO_VIDEO;
#endif
