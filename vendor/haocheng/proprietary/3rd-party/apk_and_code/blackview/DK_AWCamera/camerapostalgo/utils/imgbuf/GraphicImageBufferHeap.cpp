...
#define LOG_TAG "Postalgo/GraphicImageBufferHeap"
//
#include "MyUtils.h"
...
{
    if (CC_UNLIKELY(pImageBufferHeap->getMagicName() == nullptr || strcmp(pImageBufferHeap->getMagicName(),IGraphicImageBufferHeap::magicName())))
    {
