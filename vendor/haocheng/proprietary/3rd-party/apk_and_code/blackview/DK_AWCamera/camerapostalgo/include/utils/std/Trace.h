...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_UTILS_STD_TRACE_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_UTILS_STD_TRACE_H_
...
do{                                                                   \
    ...
    {                                                                 \
        ...
        int err = snprintf(buf, CAM_TRACE_NAME_LENGTH, fmt, ##arg);   \
        if(err >= 0 && err < CAM_TRACE_NAME_LENGTH)                   \
            CAM_TRACE_BEGIN(buf);                                     \
    }                                                                 \
}while(0)
 ...
 *
 ******************************************************************************/
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_UTILS_STD_TRACE_H_
