...
#define ADD_ALL_MEMBERS \
     ...
     _ADD_TAGMAP_(    "postalgo.mirror"  ,    MTK_POSTALGO_MIRROR  )\
     ...
     _ADD_TAGMAP_(    "postalgo.vfacebeauty.faceorientation"  ,    MTK_POSTALGO_VENDOR_FACE_BEAUTY_FACEORIENTATION  )\
     ...
     _ADD_TAGMAP_(    "postalgo.aicombo.type"  ,           MTK_POSTALGO_AI_COMBO_TYPE  )\
     _ADD_TAGMAP_(    "postalgo.aicombo.bigeye"  ,           MTK_POSTALGO_AI_COMBO_BIGEYE  )\
     _ADD_TAGMAP_(    "postalgo.aicombo.smallCheek"  ,           MTK_POSTALGO_AI_COMBO_SMALLCHEEK  )\
     _ADD_TAGMAP_(    "postalgo.aicombo.smooth"  ,           MTK_POSTALGO_AI_COMBO_SMOOTH  )\
     _ADD_TAGMAP_(    "postalgo.aicombo.white"  ,           MTK_POSTALGO_AI_COMBO_WHITE  )
#endif
