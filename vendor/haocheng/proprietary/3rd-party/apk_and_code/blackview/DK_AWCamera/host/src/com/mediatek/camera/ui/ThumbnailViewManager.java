...
//        if (mRoundedBitmap != null) {
 ...
 //       }
    ...
    private RoundedBitmapDrawable createRoundDrawable(Bitmap bitmap, final int color) {
        ...
        //bv wuyonglin modify for remove thumbnailView show border spaces 20200116 start
        //int borderWidthHalf = 2;
        int borderWidthHalf = 0;
        //bv wuyonglin modify for remove thumbnailView show border spaces 20200116 end
        ...
        //bv wuyonglin delete for remove thumbnailView show border spaces 20200116 start
        /*Paint borderPaint = new Paint();
        borderPaint.setStyle(Paint.Style.STROKE);*/

        //*/ hct.huangfei, 20201203.anti-aliasing of thumbnailview start
        ...
        //bv wuyonglin delete for remove thumbnailView show border spaces 20200116 end
