...
public class VideoUI implements IVideoUI {
    ...
    private void showTime(long millis, boolean showMillis) {
        ...
        if (mRecordingFpsView != null && mUISpec != null && mUISpec.isSupportedBurst) {
            if (mUIState == VideoUIState.STATE_BURST_RECORDING) {
    ...
    private View getView() {
        ...
        if (!"SlowMotion".equals(mApp.getAppUi().getCurrentMode())) {
            viewLayout = mActivity.getLayoutInflater().inflate(R.layout.recording,
                mParentViewGroup, true);
	} else {
            viewLayout = mActivity.getLayoutInflater().inflate(R.layout.slowmotion_recording,
                mParentViewGroup, true);
        }
        ...
        /* add by bv liangchangwei 20200915 for video captureing button anim start --*/
        Drawable drawable = mStopButton.getDrawable();
        LogHelper.i(TAG,"[getView] drawable = " + drawable);
	if (!"SlowMotion".equals(mApp.getAppUi().getCurrentMode())) {
        if(drawable instanceof AnimatedVectorDrawable){
            ...
            mMainHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    mStopButton.setImageDrawable(mActivity.getResources().getDrawable(R.drawable.ic_stop_recording_pic));
                }
            }, 100);
        }
	} else {
            if (drawable instanceof AnimatedVectorDrawable) {
                ...
                mMainHandler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                         mStopButton.setImageDrawable(mActivity.getResources().getDrawable(R.drawable.ic_slowmotion_stop_recording_pic));
                    }
                }, 100);
            }
	}
        /* add by bv liangchangwei 20200915 for video captureing button anim end --*/
	...
	if (mScreenHeight == 1560) {
        RelativeLayout.LayoutParams params1 =
                 (RelativeLayout.LayoutParams) mStopButton.getLayoutParams();
        params1.setMargins(params1.leftMargin, params1.topMargin,
                params1.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_stop_margin_Bottom_1560px));
        mStopButton.setLayoutParams(params1);
        RelativeLayout.LayoutParams params2 =
                 (RelativeLayout.LayoutParams) mPauseResumeButton.getLayoutParams();
        params2.setMargins(params2.leftMargin, params2.topMargin,
                params2.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_pause_margin_Bottom_1560px));
        mPauseResumeButton.setLayoutParams(params2);
        RelativeLayout.LayoutParams params3 =
                 (RelativeLayout.LayoutParams) mVssButton.getLayoutParams();
        params3.setMargins(params3.leftMargin, params3.topMargin,
                params3.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_vss_margin_Bottom_1560px));
        mVssButton.setLayoutParams(params3);
        //bv wuyonglin add for screen 1440px adjust all icon position 20200709 start
	} else if (mScreenHeight == 1440) {
        RelativeLayout.LayoutParams params1 =
                 (RelativeLayout.LayoutParams) mStopButton.getLayoutParams();
        params1.setMargins(params1.leftMargin, params1.topMargin,
                params1.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_stop_margin_Bottom_1440px));
        mStopButton.setLayoutParams(params1);
        RelativeLayout.LayoutParams params2 =
                 (RelativeLayout.LayoutParams) mPauseResumeButton.getLayoutParams();
        params2.setMargins(params2.leftMargin, params2.topMargin,
                params2.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_pause_margin_Bottom_1440px));
        mPauseResumeButton.setLayoutParams(params2);
        RelativeLayout.LayoutParams params3 =
                 (RelativeLayout.LayoutParams) mVssButton.getLayoutParams();
        params3.setMargins(params3.leftMargin, params3.topMargin,
                params3.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_vss_margin_Bottom_1440px));
        mVssButton.setLayoutParams(params3);
        ...
        RelativeLayout.LayoutParams params1 =
                 (RelativeLayout.LayoutParams) mStopButton.getLayoutParams();
        params1.setMargins(params1.leftMargin, params1.topMargin,
                params1.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_stop_margin_Bottom_2300px));
        mStopButton.setLayoutParams(params1);
        RelativeLayout.LayoutParams params2 =
                 (RelativeLayout.LayoutParams) mPauseResumeButton.getLayoutParams();
        params2.setMargins(params2.leftMargin, params2.topMargin,
                params2.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_pause_margin_Bottom_2300px));
        mPauseResumeButton.setLayoutParams(params2);
        RelativeLayout.LayoutParams params3 =
                 (RelativeLayout.LayoutParams) mVssButton.getLayoutParams();
        params3.setMargins(params3.leftMargin, params3.topMargin,
                params3.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_vss_margin_Bottom_2300px));
        mVssButton.setLayoutParams(params3);
	} else if (mScreenHeight == 2400) {
        RelativeLayout.LayoutParams params1 =
                 (RelativeLayout.LayoutParams) mStopButton.getLayoutParams();
        params1.setMargins(params1.leftMargin, params1.topMargin,
                params1.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_stop_margin_Bottom_2400px));
        mStopButton.setLayoutParams(params1);
        RelativeLayout.LayoutParams params2 =
                 (RelativeLayout.LayoutParams) mPauseResumeButton.getLayoutParams();
        params2.setMargins(params2.leftMargin, params2.topMargin,
                params2.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_pause_margin_Bottom_2400px));
        mPauseResumeButton.setLayoutParams(params2);
        RelativeLayout.LayoutParams params3 =
                 (RelativeLayout.LayoutParams) mVssButton.getLayoutParams();
        params3.setMargins(params3.leftMargin, params3.topMargin,
                params3.rightMargin, mApp.getActivity().getResources().getDimensionPixelSize(R.dimen.camera_video_vss_margin_Bottom_2400px));
        mVssButton.setLayoutParams(params3);
	}
        //bv wuyonglin add for adjust all icon position 20200612 end
    ...
    private void updateRecordingViewIcon() {
        //int recordingId = R.drawable.ic_recording_indicator;    //bv wuyonglin delete for video UI
        int recordingId = R.drawable.bv_ic_recording_indicator;	//bv wuyonglin add for video UI
        int playPauseId = R.drawable.ic_pause_recording;
        if (mUIState == VideoUIState.STATE_PAUSE_RECORDING) {
            //recordingId = R.drawable.ic_pause_indicator;    //bv wuyonglin delete for video UI
