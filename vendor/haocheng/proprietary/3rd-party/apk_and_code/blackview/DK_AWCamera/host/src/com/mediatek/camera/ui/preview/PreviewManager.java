...
public class PreviewManager {
    ...
    public PreviewManager(IApp app) {
        ...
        if (enabledValue == SURFACEVIEW_ENABLED_VALUE || appVersion == DEFAULT_APP_VERSION) {
			...
			mPreviewController = new SurfaceViewController(app,mPreviewFrameLayout);
			//modify by huangfei for preview layout relayout end
        } else {
			//modify by huangfei for preview layout relayout start
            //mPreviewController = new TextureViewController(app);
			mPreviewController = new TextureViewController(app,mPreviewFrameLayout);
			//modify by huangfei for preview layout relayout end
        }
	...
	public void hide(){
		mPreviewController.hide();
	}
	public void show(){
		mPreviewController.show();
	}
	//add by huangfei for previewmanager hide end


    public IController getPreviewController() {
