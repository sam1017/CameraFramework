...
public class AIBokehPhotoEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AIBokehPhotoEntry.class
            .getSimpleName());
     ...
     */
    public AIBokehPhotoEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return AIBokehPhotoEntry.class.getName();
    }
