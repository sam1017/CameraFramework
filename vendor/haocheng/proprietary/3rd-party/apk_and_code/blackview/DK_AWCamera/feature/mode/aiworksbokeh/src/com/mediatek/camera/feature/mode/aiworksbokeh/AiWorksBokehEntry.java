...
public class AiWorksBokehEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AiWorksBokehEntry.class.getSimpleName());
    private static final String MODE_ITEM_TYPE = "Picture";

    public static final int MODE_ITEM_PRIORITY = 140;
     ...
     */
    public AiWorksBokehEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return AiWorksBokehEntry.class.getName();
    }
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mMode = "AiWorksBokeh";
        modeItem.mTitle = mContext.getResources().getString(R.string.accessibility_switch_to_aiworksbokeh);
        modeItem.mModeName = mContext.getString(R.string.accessibility_switch_to_aiworksbokeh);
        return modeItem;
    }
}
