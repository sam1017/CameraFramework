...
public class NightEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(NightEntry.class.getSimpleName());
    private static final String MODE_ITEM_TYPE = "Picture";

    public static final int MODE_ITEM_PRIORITY = 55; //bv wuyonglin modify for detail fragment auto adapt 20210407
     ...
     */
    public NightEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return NightEntry.class.getName();
    }
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mModeName = mContext.getString(R.string.accessibility_switch_to_night);
        modeItem.mSupportedCameraIds = new String[]{"0","1","2"};
        modeItem.mMode = "Night";
        modeItem.mTitle = mContext.getResources().getString(R.string.accessibility_switch_to_night);
