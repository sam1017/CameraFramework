...
public class Hdr10SettingView implements ICameraSettingView {
    private static final LogUtil.Tag TAG =
            new LogUtil.Tag(Hdr10SettingView.class.getSimpleName());
    private static final String KEY_HDR10 = "key_hdr10";
    private SwitchPreference mPref;
    private OnHdr10ViewListener mViewListener;
    private boolean mChecked;
    private boolean mEnabled;

    /**
     * Listener with HDR10+ view.
     */
    interface OnHdr10ViewListener {
    ...
    public void loadView(PreferenceFragment fragment) {
        ...
        fragment.addPreferencesFromResource(R.xml.hdr10_preference);
        mPref = (SwitchPreference) fragment.findPreference(KEY_HDR10);
        mPref.setRootPreference(fragment.getPreferenceScreen());
        mPref.setId(R.id.hdr10_setting);
        mPref.setContentDescription(fragment.getActivity().getResources()
                .getString(R.string.hdr10_content_description));
     ...
     */
    public void setHdr10Listener(OnHdr10ViewListener viewListener) {
