...
/**
 * LOCATION entry for feature provider.
 */

public class LocationEntry extends FeatureEntryBase {
     ...
     */
    public LocationEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        return Config.locationSupport(mContext);
        //add by huangfei for location end
    }

    @Override
    public String getFeatureEntryName() {
        return LocationEntry.class.getName();
    }
