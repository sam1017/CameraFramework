...
public class PreviewModeSelector extends PreferenceFragment {
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(PreviewModeSelector.class.getSimpleName());
    ...
    /**
     * Set preview mode entries and entry values.
     *
     * @param entries preview mode entries.
     * @param entryValues preview mode entry values.
     */
    ...
    /**
     * preview mode preference click listener.
     */
