...
public class AIComboPhotoHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AIComboPhotoHelper.class.getSimpleName());
     ...
     */
    public AIComboPhotoHelper(ICameraContext cameraContext) {
