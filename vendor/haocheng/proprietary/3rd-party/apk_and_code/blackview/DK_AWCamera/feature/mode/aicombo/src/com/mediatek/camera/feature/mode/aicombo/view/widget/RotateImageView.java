 ...
 */
package com.mediatek.camera.feature.mode.aicombo.view.widget;
...
import com.mediatek.camera.common.widget.TwoStateImageView;

/**
 * A @{code ImageView} which can rotate it's content.
 */
public class RotateImageView extends TwoStateImageView implements Rotatable {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(RotateImageView.class.getSimpleName());
    ...
    public void setOrientation(int degree, boolean animation) {
        LogHelper.d(TAG, "[setOrientation]degree = " + degree + ", animation=" + animation
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable == null) {
            LogHelper.e(TAG, "[onDraw]drawable == null, return!");
            return;
        }
        ...
        if (w == 0 || h == 0) {
            LogHelper.e(TAG, "[onDraw]w == 0 || h == 0, return!");
