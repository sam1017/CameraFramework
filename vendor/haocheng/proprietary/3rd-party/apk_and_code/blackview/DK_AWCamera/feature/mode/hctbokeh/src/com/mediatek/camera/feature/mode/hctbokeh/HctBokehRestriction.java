...
public class HctBokehRestriction {
    // This key must same as every setting keys define, otherwise will have no role about the
    // restriction.
    private static final String KEY_HCTBOKEH= HctBokehMode.class.getName();
    ...
    static {
        sRelation.setHeaderKey(KEY_HCTBOKEH);
        sRelation.setBodyKeys(KEY_CSHOT + "," + KEY_FLASH + "," + KEY_FACE_DETECTION + "," +
                ...
                KEY_COLOR_EFFECT + "," + KEY_AIS + "," + KEY_WATER_MARK + "," + KEY_TRIPLE_SWITCH+ "," + KEY_CAMERA_ZOOM);
        sRelation.addRelation(
                new Relation.Builder(KEY_HCTBOKEH, "on")
    ...
    static {
        sFrontRelation.setHeaderKey(KEY_HCTBOKEH);
