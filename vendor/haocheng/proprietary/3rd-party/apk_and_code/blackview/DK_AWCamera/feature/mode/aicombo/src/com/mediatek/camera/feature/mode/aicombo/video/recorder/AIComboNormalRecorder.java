 ...
 */
package com.mediatek.camera.feature.mode.aicombo.video.recorder;
 ...
 * and other platform can extend it or implement ISdofRecorder to realize new feature.
 */
public class AIComboNormalRecorder implements IAIComboRecorder {
    private static final Tag TAG = new Tag(AIComboNormalRecorder.class.getSimpleName());
    ...
    /**
     * the construction for AIComboNormalRecorder.
     */
    public AIComboNormalRecorder() {
