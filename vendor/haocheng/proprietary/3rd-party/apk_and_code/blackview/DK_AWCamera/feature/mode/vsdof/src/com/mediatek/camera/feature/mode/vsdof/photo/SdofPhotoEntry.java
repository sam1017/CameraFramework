    ...
    public IAppUi.ModeItem getModeItem() {
        ...
        if (CameraUtil.getLogicalCameraId() == null
            ...
            modeItem.mSupportedCameraIds = new String[]{"0",
                ...
                && CameraUtil.getFrontLogicalId() != null) {
            modeItem.mSupportedCameraIds = new String[]{"0", "1",
                    CameraUtil.getFrontLogicalId(), CameraUtil.getDualZoomId()};
        } else if (CameraUtil.getLogicalCameraId() != null
                && CameraUtil.getDualZoomId() == null
                && CameraUtil.getFrontLogicalId() == null) {
            modeItem.mSupportedCameraIds = new String[]{"0",
                ...
                && CameraUtil.getFrontLogicalId() != null) {
            modeItem.mSupportedCameraIds = new String[]{"0", "1",
                    CameraUtil.getFrontLogicalId(), CameraUtil.getLogicalCameraId()};
        } else if (CameraUtil.getLogicalCameraId() != null
                && CameraUtil.getDualZoomId() != null
                && CameraUtil.getFrontLogicalId() == null) {
            modeItem.mSupportedCameraIds = new String[]{"0",
                ...
                && CameraUtil.getDualZoomId() != null
                && CameraUtil.getFrontLogicalId() != null) {
            modeItem.mSupportedCameraIds = new String[]{"0", "1", CameraUtil.getFrontLogicalId(),
                    CameraUtil.getLogicalCameraId(), CameraUtil.getDualZoomId()};
        } else {
            modeItem.mSupportedCameraIds = new String[]{"0", "1", CameraUtil.getFrontLogicalId(),
                    CameraUtil.getLogicalCameraId(), CameraUtil.getDualZoomId()};
