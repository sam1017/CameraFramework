...
public class SuperphotoModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(SuperphotoModeHelper.class.getSimpleName());
     ...
     */
    public SuperphotoModeHelper(ICameraContext cameraContext) {
