...
public class StoragePathSelector extends PreferenceFragment {
    ...
    private Preference.OnPreferenceClickListener mOnPreferenceClickListener
            = new StoragePathPreferenceClickListener();
    private IStoragePathViewListener.OnItemClickListener mListener;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            toolbar.setTitle(getActivity().getString(R.string.storage_path_title));
        }
        addPreferencesFromResource(R.xml.storage_path_selector_preference);
     ...
     */
    public void setOnItemClickListener(IStoragePathViewListener.OnItemClickListener listener) {
        mListener = listener;
    }
    ...
    private String getTitlePattern(String value) {
        if (value.equals(IStoragePathViewListener.EXTERNAL_STORAGE)) {
            return getActivity().getString(R.string.storage_path_external);
        }  else {
            return getActivity().getString(R.string.storage_path_internal);
        }
    }
}
