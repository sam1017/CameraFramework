...
public class AISlimmingVideoModeEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AISlimmingVideoModeEntry.class
            .getSimpleName());
     ...
     */
    public AISlimmingVideoModeEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return AISlimmingVideoModeEntry.class.getName();
    }
    ...
    public Object createInstance() {
        return new AISlimmingVideoMode();
    }
