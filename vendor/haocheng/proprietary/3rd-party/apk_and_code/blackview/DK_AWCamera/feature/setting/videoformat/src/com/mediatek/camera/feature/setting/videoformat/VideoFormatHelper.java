...
public class VideoFormatHelper {
    ...
    private static final String  FORMAT_HEVC = "HEVC";
     ...
     static String getQualityTitle(Activity activity, String quality) {
        String title = "";
        switch (quality) {
            case FORMAT_H264:
                title=activity.getResources().getString(R.string.format_most_compatible);
                break;
            case FORMAT_HEVC:
                title = activity.getResources().getString(R.string.format_high_efficiency);
                break;
            default:
                break;
        }
