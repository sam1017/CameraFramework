...
/**
 * This class is for tpi fb feature entry.
 */

public class DemoFbEntry extends FeatureEntryBase {
	/**
	 * create an entry.
	 *
	 ...
	 */
	public DemoFbEntry(Context context, Resources resources) {
	...
	public String getFeatureEntryName() {
		return DemoFbEntry.class.getName();
	}
