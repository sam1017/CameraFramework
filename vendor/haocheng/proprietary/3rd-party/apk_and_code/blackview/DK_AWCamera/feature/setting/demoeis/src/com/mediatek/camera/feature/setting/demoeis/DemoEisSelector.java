...
public class DemoEisSelector extends PreferenceFragment {

	private static final LogUtil.Tag TAG
			= new LogUtil.Tag(DemoEisSelector.class.getSimpleName());
	...
	private Preference.OnPreferenceClickListener mOnPreferenceClickListener
			= new TPIEisPreferenceClickListener();
	private DemoEisSettingViewListener.OnItemClickListener mListener;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (toolbar != null) {
			toolbar.setTitle(getActivity().getString(R.string.demo_eis_title));
		}
		addPreferencesFromResource(R.xml.demo_eis_selector_preference);
	 ...
	 *
	 * @param listener The instance of {@link DemoEisSettingViewListener.OnItemClickListener}.
	 */
	public void setOnItemClickListener(DemoEisSettingViewListener.OnItemClickListener listener) {
		mListener = listener;
	}
	...
	private String getTitlePattern(String value) {
		if (value.equals(DemoEisSettingViewListener.ON_RECORD_ONLY)) {
			return getActivity().getString(R.string.demo_eis_on);
		} else if (value.equals(DemoEisSettingViewListener.OFF)) {
			return getActivity().getString(R.string.demo_eis_off);
		} else {
			return getActivity().getString(R.string.demo_eis_on_and_chang_roi);
		}
	}

	/**
	 * tpi eis preference click listener.
	 */
	private class TPIEisPreferenceClickListener implements Preference.OnPreferenceClickListener {
		@Override
