 ...
 */
public interface IProDeviceController {

    void addExif(String filePath, byte[] data);
    ...
    interface DeviceCallback {
        ...
        void setFoucsDistance(int distance);
     ...
     */
    void openCamera(ProDeviceInfo info);
     ...
     */
    void takePicture(@Nonnull IProDeviceController.CaptureDataCallback callback);
	...
	/**
     * this add by Jerry for wb
     *
     */
    void setWbValue(String wb);

    /**
     * this add by Jerry for ISO
     *
     */
    void setISOValue(String iso);

    /**
     * this add by Jerry for MF
     *
     */
    void setMFValue(String mf);
    /**
     * this add by Jerry for EXP
     *
     */
    void setExpValue(String value);

    //add by huangfei for shutter start
    /**
     * this add by huangfei for shutter
     *
     */
    void setShutterValue(String value);

    /**
     * this add by huangfei for if show SeekArcFrameLayout
     *
     */
    void onShowSeekArcFrameLayout(boolean show);
