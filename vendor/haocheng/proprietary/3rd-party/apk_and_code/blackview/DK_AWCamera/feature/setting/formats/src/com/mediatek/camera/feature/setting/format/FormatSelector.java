...
public class FormatSelector extends PreferenceFragment {
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(FormatSelector.class.getSimpleName());
     ...
     *
     * @param listener The instance of {@link IFormatViewListener.OnItemClickListener}.
     */
    public void setOnItemClickListener(IFormatViewListener.OnItemClickListener listener) {
        mListener = listener;
    }
     ...
     *
     * @param entryValues The formats supported.
     */
    ...
    private String getTitlePattern(String value) {
        if (value.equals(Format.FORMAT_JPEG)) {
            return getActivity().getString(R.string.format_entry_0);
        } else if (value.equals(Format.FORMAT_HEIF)) {
