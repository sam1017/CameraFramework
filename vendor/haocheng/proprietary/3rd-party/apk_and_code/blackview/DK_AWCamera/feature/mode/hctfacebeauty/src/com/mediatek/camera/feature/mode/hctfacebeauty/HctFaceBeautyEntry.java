...
public class HctFaceBeautyEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(HctFaceBeautyEntry.class.getSimpleName());
    private static final String MODE_ITEM_TYPE = "Picture";

    private static final int MODE_ITEM_PRIORITY = 105;
    /**
     * create an entry.
     *
     ...
     */
    public HctFaceBeautyEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        if (!isThirdPartyIntent(activity)&&Config.isHctBeautySupported()) {
            support = true;
        }
    ...
    public String getFeatureEntryName() {
        return HctFaceBeautyEntry.class.getName();
    }
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mMode = "HctFaceBeautyEntry";
        modeItem.mTitle = mContext.getResources().getString(R.string.accessibility_switch_to_hctfacebeauty);
        modeItem.mModeName = mContext.getString(R.string.accessibility_switch_to_hctfacebeauty);
        return modeItem;
    }
}
