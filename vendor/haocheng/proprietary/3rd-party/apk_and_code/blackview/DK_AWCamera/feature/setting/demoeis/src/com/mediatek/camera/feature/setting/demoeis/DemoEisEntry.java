...
/**
 * This class is for tpi eis feature entry.
 */

public class DemoEisEntry extends FeatureEntryBase {
	/**
	 * create an entry.
	 *
	 ...
	 */
	public DemoEisEntry(Context context, Resources resources) {
	...
	public String getFeatureEntryName() {
		return DemoEisEntry.class.getName();
	}
