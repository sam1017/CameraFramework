...
public class AntiFlicker extends SettingBase implements
    ...
    //add by huangfei for default AntiFlicker value start
    private String mDefaultVaule = "auto";
    //add by huangfei for default AntiFlicker value end
    ...
    public void init(IApp app,
        ...
        //add by huangfei for default AntiFlicker value start
        mDefaultVaule = app.getActivity().getResources().getString(R.string.antiflicker_default_value);;
        //add by huangfei for default AntiFlicker value end
    ...
    public void initializeValue(List<String> platformSupportedValues, String defaultValue) {
        ...
        //modify by huangfei for default AntiFlicker value start
        //String value = mDataStore.getValue(getKey(), defaultValue, getStoreScope());
        String value = mDataStore.getValue(getKey(), mDefaultVaule, getStoreScope());
        //modify by huangfei for default AntiFlicker value end
    ...
    private IAppUi.RestoreSettingListener mRestoreSettingListener = new IAppUi.RestoreSettingListener() {
        ...
        public void restoreSettingtoValue() {
            setValue(mDefaultVaule);
            mDataStore.setValue(getKey(), mDefaultVaule, getStoreScope(), true);
            mSettingChangeRequester.sendSettingChangeRequest();
        }
    };
    //bv wuyonglin add for setting ui 20200923 end
