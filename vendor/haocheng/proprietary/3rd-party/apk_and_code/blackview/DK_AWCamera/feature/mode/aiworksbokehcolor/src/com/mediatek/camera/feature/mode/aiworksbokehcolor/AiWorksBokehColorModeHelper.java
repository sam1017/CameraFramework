...
public class AiWorksBokehColorModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AiWorksBokehColorModeHelper.class.getSimpleName());
     ...
     */
    public AiWorksBokehColorModeHelper(ICameraContext cameraContext) {
