...
/**
 * Define the interaction apis between {@link NightMode} and Camera Device,
 ...
 */
public interface INightDeviceController {
     ...
     */
    void openCamera(NightDeviceInfo info);
     ...
     */
    void takePicture(@Nonnull INightDeviceController.CaptureDataCallback callback);
    ...
    void addExif(String path, byte[] data);
}
