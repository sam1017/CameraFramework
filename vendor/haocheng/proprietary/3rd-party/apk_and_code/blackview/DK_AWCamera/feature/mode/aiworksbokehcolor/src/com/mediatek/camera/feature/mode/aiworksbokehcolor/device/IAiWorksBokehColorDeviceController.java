...
/**
 * Define the interaction apis between {@link AiWorksBokehMode} and Camera Device,
 ...
 */
public interface IAiWorksBokehColorDeviceController {
    ...
    interface DeviceCallback {
        ...
        void onAiworksPreviewCallback(byte[] data, int format, int width, int height);
    }
     ...
     */
    void openCamera(AiWorksBokehColorDeviceInfo info);
     ...
     */
    void takePicture(@Nonnull IAiWorksBokehColorDeviceController.CaptureDataCallback callback);
	...
	void setBokehParameter(int level,int x,int y,int r);
}
