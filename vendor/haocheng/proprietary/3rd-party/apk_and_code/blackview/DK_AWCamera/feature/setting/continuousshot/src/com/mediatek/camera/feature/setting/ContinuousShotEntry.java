...
public class ContinuousShotEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(
            ContinuousShotEntry.class.getSimpleName());
    private static final String NAME = ContinuousShotEntry.class.getName();
    private static final int CSHOT_VERSION_FAST_PREVIEW = 1;
    private static final int CSHOT_VERSION_TB_ESPECIAL = 2;
    ...
    public Object createInstance() {
        int version = SystemProperties.getInt("vendor.mtkcamapp.cshot.version", 1);
        if (version == CSHOT_VERSION_FAST_PREVIEW) {
            //always override
            mIsBurstMode = false;
            return new ContinuousShot2();
        } else if (version == CSHOT_VERSION_TB_ESPECIAL) {
            mIsBurstMode = true;
