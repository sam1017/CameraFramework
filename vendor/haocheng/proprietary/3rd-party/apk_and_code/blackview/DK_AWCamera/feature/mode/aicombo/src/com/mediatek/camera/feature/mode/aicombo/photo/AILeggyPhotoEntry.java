...
public class AILeggyPhotoEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AILeggyPhotoEntry.class
            .getSimpleName());
     ...
     */
    public AILeggyPhotoEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return AILeggyPhotoEntry.class.getName();
    }
