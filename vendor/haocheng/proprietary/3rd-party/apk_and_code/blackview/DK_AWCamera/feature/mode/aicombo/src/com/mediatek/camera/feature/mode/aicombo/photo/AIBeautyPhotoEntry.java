...
public class AIBeautyPhotoEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AIBeautyPhotoEntry.class
            .getSimpleName());
     ...
     */
    public AIBeautyPhotoEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return AIBeautyPhotoEntry.class.getName();
    }
