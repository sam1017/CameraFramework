...
/**
 * continuous shot selector.
 */

public class ContinuousShotSelector extends PreferenceFragment {
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(ContinuousShotSelector.class.getSimpleName());
    ...
    private Preference.OnPreferenceClickListener mOnPreferenceClickListener
            = new ContinuousShotPreferenceClickListener();
    private IContinuousShotViewListener.OnItemClickListener mListener;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            toolbar.setTitle(getActivity().getString(R.string.continuous_shot_title));
        }
        addPreferencesFromResource(R.xml.continuous_shot_selector_preference);
        mPreferences = getActivity().getSharedPreferences(CameraUtil.CAMERA_SHARED_PREFS_BACK, Context.MODE_PRIVATE);
        mSelectedValue = mPreferences.getString(IContinuousShotViewListener.KEY_CONTINUOUS_SHOT_NUM,"20");
     ...
     *
     * @param listener The instance of {@link IContinuousShotViewListener.OnItemClickListener}.
     */
    public void setOnItemClickListener(IContinuousShotViewListener.OnItemClickListener listener) {
        mListener = listener;
    }
    ...
    /**
     * continuous shot preference click listener.
     */
    private class ContinuousShotPreferenceClickListener implements Preference.OnPreferenceClickListener {
        @Override
    ...
    private String getTitlePattern(String value) {
        if(value.equals(IContinuousShotViewListener.CONTINUOUS_SHOT_NUM10)) {
            return getActivity().getString(R.string.continuous_shot_num_10);
        }else{
            return getActivity().getString(R.string.continuous_shot_num_20);
        }
    }
}
