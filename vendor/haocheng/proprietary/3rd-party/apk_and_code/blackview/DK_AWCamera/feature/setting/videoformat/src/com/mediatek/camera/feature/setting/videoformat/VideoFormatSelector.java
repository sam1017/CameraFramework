...
public class VideoFormatSelector extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getActivity().getResources().getString(R.string.video_format_title));
    ...
    private void filterValuesOnShown() {
        ...
        for (int i = 0; i < tempValues.size(); i++) {
            ...
            String resolution = tempValues.get(i);
            String title = VideoFormatHelper.getQualityTitle(mActivity, value);
            if (title != null) {
