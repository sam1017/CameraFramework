...
public class SdofCaptureSurface {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(SdofCaptureSurface.class.getSimpleName());
     ...
     */
    public SdofCaptureSurface() {
        LogHelper.d(TAG, "[SdofCaptureSurface]Construct");
