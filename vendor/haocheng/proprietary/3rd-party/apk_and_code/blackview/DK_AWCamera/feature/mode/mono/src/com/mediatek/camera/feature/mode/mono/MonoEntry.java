...
public class MonoEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(MonoEntry.class.getSimpleName());
    private static final String MODE_ITEM_TYPE = "Picture";

    public static final int MODE_ITEM_PRIORITY = 148;
     ...
     */
    public MonoEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        if (!isThirdPartyIntent(activity) && Config.isMonoModeSupprot(activity)) {
        /* }@ hct.wangsenhao */
            support = true;
        }
    ...
    public String getFeatureEntryName() {
        return MonoEntry.class.getName();
    }
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mModeName = mContext.getString(R.string.accessibility_switch_to_mono);
        modeItem.mSupportedCameraIds = new String[]{"0", "1"};
        modeItem.mMode = "Mono";
        modeItem.mTitle = mContext.getResources().getString(R.string.accessibility_switch_to_mono);
