...
public class HctBokehModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(HctBokehModeHelper.class.getSimpleName());
     ...
     */
    public HctBokehModeHelper(ICameraContext cameraContext) {
