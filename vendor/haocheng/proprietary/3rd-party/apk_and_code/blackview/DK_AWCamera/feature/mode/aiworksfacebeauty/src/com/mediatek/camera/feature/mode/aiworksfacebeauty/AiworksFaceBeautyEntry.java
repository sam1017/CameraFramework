...
public class AiworksFaceBeautyEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AiworksFaceBeautyEntry.class.getSimpleName());
    private static final String MODE_ITEM_TYPE = "Picture";

    public static final int MODE_ITEM_PRIORITY = 135; //bv wuyonglin modify for detail fragment auto adapt 20210407
    /**
     * create an entry.
     *
     ...
     */
    public AiworksFaceBeautyEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        LogHelper.i(TAG, "geek [isSupport] : " + support);
        return support;
    }
    ...
    public String getFeatureEntryName() {
        return AiworksFaceBeautyEntry.class.getName();
    }
    ...
    public Object createInstance() {
        return new AiworksFaceBeautyMode();
    }
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mMode = "AiworksFaceBeauty";
        modeItem.mTitle = mContext.getResources().getString(R.string.accessibility_switch_to_pifacebeauty);
        modeItem.mModeName = mContext.getString(R.string.accessibility_switch_to_pifacebeauty);
        return modeItem;
    }
}
