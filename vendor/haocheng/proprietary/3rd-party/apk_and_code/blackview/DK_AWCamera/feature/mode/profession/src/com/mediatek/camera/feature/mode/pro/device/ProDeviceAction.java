...
public class ProDeviceAction {
    ...
    static final int SET_WB = 18;
    static final int SET_ISO = 19;
    static final int SET_MF = 20;
    static final int SET_EXP = 21;

    //add by huangfei for shutter start
    static final int SET_SHUTTER = 22;
