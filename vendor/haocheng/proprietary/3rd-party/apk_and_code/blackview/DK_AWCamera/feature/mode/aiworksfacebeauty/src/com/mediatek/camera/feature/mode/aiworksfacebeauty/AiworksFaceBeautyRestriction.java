...
public class AiworksFaceBeautyRestriction {
    // This key must same as every setting keys define, otherwise will have no role about the
    // restriction.
    private static final String KEY_AiworksFaceBeauty= AiworksFaceBeautyMode.class.getName();
    ...
    static {
        sRelation.setHeaderKey(KEY_AiworksFaceBeauty);
        sRelation.setBodyKeys(KEY_CSHOT + "," + KEY_FACE_DETECTION + "," +
                KEY_HDR + "," + KEY_ZSD + "," + KEY_DNG + "," + KEY_SELF_TIMER + "," +
                KEY_SCENE_MODE + "," +
                KEY_COLOR_EFFECT+ "," +
                KEY_WHITE_BALANCE + "," + KEY_TRIPLE_SWITCH + "," + KEY_CAMERA_ZOOM + "," + KEY_AIS);	//bv wuyonglin add for face beauty mode should can not zoom 20200731 
        sRelation.addRelation(
                new Relation.Builder(KEY_AiworksFaceBeauty, "on")
                        ...
                        //bv wuyonglin add for face beauty mode should can not zoom 20200731 start
                        .addBody(KEY_CAMERA_ZOOM, "off", "off")
                        //bv wuyonglin add for face beauty mode should can not zoom 20200731 end
                        .addBody(KEY_AIS, "off", "off")	//bv wuyonglin add for hd shot 20201013
                        .build());
    }
