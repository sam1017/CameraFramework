...
/**
 * Define the interaction apis between {@link AiworksFaceBeautyMode} and Camera Device,
 ...
 */
public interface IAiworksFaceBeautyDeviceController {
     ...
     */
    void openCamera(AiworksFaceBeautyDeviceInfo info);
     ...
     */
    void takePicture(@Nonnull IAiworksFaceBeautyDeviceController.CaptureDataCallback callback);
	...
	void setBeautyParameter(int smooth,int whilen,int thin,int bigeye,int brighteye, int bignose);
}
