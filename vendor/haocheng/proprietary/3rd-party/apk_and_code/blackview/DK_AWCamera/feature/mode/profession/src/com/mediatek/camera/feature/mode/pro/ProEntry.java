 ...
 * Photo mode entry.
 */
public class ProEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(ProEntry.class.getSimpleName());
    private static final String MODE_ITEM_TYPE = "Picture";

    public static final int MODE_ITEM_PRIORITY = 151;
    /**
     * create an entry.
     *
     ...
     */
    public ProEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        ...
        if (!isThirdPartyIntent(activity) && Config.isProModeSupprot(activity)) {
        /* }@ hct.wangsenhao */
            support = true;
        }
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mModeName = mContext.getString(R.string.accessibility_switch_to_pro);
        modeItem.mSupportedCameraIds = new String[]{"0"};
        modeItem.mMode = "Pro";
        modeItem.mTitle = mContext.getResources().getString(R.string.accessibility_switch_to_pro);
        return modeItem;
    }
}
