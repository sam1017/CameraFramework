...
/**
 * This class is for tpi async feature entry.
 */

public class DemoAsdEntry extends FeatureEntryBase {
	/**
	 * create an entry.
	 *
	 ...
	 */
	public DemoAsdEntry(Context context, Resources resources) {
	...
	public String getFeatureEntryName() {
		return DemoAsdEntry.class.getName();
	}
