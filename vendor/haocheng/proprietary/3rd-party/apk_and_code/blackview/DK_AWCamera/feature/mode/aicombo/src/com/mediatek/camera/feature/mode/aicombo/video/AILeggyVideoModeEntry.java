...
public class AILeggyVideoModeEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AILeggyVideoModeEntry.class
            .getSimpleName());
     ...
     */
    public AILeggyVideoModeEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return AILeggyVideoModeEntry.class.getName();
    }
    ...
    public IAppUi.ModeItem getModeItem() {
        ...
        modeItem.mModeSelectedIcon = mResources.getDrawable(R.drawable.ic_ai_leggy_mode_selected);
        modeItem.mModeUnselectedIcon = mResources.getDrawable(R.drawable.ic_ai_leggy_mode_unselected);
        modeItem.mModeName = mResources.getString(R.string.aileggy_mode_name);
