...
public class HctFaceBeautyModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(HctFaceBeautyModeHelper.class.getSimpleName());
     ...
     */
    public HctFaceBeautyModeHelper(ICameraContext cameraContext) {
