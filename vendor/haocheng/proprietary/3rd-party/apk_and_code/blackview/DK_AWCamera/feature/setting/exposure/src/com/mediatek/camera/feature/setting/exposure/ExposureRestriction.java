...
class ExposureRestriction {
    ...
    static final String EXPOSURE_PRE_CAPTURE_START = "pre_capture_start";
    ...
    static {
        sRelation.setHeaderKey(EXPOSURE_KEY);
        sRelation.setBodyKeys(ZSD_KEY);
        sRelation.addRelation(
                new Relation.Builder(EXPOSURE_KEY, EXPOSURE_PRE_CAPTURE_START)
                        .addBody(ZSD_KEY, "off", "on,off")
                        .build());
    }
