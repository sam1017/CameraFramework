...
/**
 * This restriction is used by superphoto.
 */

public class SuperphotoRestriction {
    // This key must same as every setting keys define, otherwise will have no role about the
    // restriction.
    private static final String KEY_SUPERPHOTO= SuperphotoMode.class.getName();
    ...
    static {
        sRelation.setHeaderKey(KEY_SUPERPHOTO);
        sRelation.setBodyKeys(KEY_CSHOT + "," /*+ KEY_FLASH + "," /*HCT.ouyang + KEY_FACE_DETECTION + ","*/ +
                ...
                KEY_SCENE_MODE + "," + KEY_COLOR_EFFECT + "," + KEY_AIS+ "," + KEY_WHITE_BALANCE + "," + KEY_TRIPLE_SWITCH + "," + KEY_CAMERA_ZOOM + "," + KEY_CAMERA_SWITCHER);
        sRelation.addRelation(
                new Relation.Builder(KEY_SUPERPHOTO, "on")
