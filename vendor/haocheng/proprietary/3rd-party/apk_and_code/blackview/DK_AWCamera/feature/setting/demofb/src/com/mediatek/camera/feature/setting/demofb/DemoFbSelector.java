...
public class DemoFbSelector extends PreferenceFragment {

	private static final LogUtil.Tag TAG
			= new LogUtil.Tag(DemoFbSelector.class.getSimpleName());
	...
	private Preference.OnPreferenceClickListener mOnPreferenceClickListener
			= new TPIFBPreferenceClickListener();
	private DemoFbSettingViewListener.OnItemClickListener mListener;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (toolbar != null) {
			toolbar.setTitle(getActivity().getString(R.string.demo_fb_title));
		}
		addPreferencesFromResource(R.xml.demo_fb_selector_preference);
	 ...
	 *
	 * @param listener The instance of {@link DemoFbSettingViewListener.OnItemClickListener}.
	 */
	public void setOnItemClickListener(DemoFbSettingViewListener.OnItemClickListener listener) {
		mListener = listener;
	}
	...
	private String getTitlePattern(String value) {
		if (value.equals(DemoFbSettingViewListener.ON)) {
			return getActivity().getString(R.string.demo_fb_on);
		} else if (value.equals(DemoFbSettingViewListener.OFF)) {
			return getActivity().getString(R.string.demo_fb_off);
		} else {
			return getActivity().getString(R.string.demo_fb_on_and_chang_roi);
		}
	}

	/**
	 * tpi fb preference click listener.
	 */
	private class TPIFBPreferenceClickListener implements Preference.OnPreferenceClickListener {
		@Override
