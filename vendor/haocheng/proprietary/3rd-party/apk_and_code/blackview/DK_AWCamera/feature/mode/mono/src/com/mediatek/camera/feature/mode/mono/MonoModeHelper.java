...
public class MonoModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(MonoModeHelper.class.getSimpleName());
     ...
     */
    public MonoModeHelper(ICameraContext cameraContext) {
