...
class PanoramaRestriction {
    ...
    //*/ hct.huangfei, 20201103. modify panorama.
    ...
    static {
        ...
        sRelation.setBodyKeys(KEY_CSHOT + "," + KEY_FLASH + "," + KEY_FACE_DETECTION + "," +
                ...
                KEY_COLOR_EFFECT + "," + KEY_AIS+ "," + KEY_CAMERA_ZOOM + "," + KEY_WHITE_BALANCE+ ","
                 + KEY_WATER_MARK + "," + KEY_ISO);
        sRelation.addRelation(
                new Relation.Builder(KEY_PANORAMA, "on")
                        ...
                        .addBody(KEY_WATER_MARK, "off", "off")
                        .addBody(KEY_ISO, "0", "0")
                        //*/
                        .build());
    }
    ...
    static {
        ...
        s3aRelation.addRelation(
                new Relation.Builder(KEY_PANORAMA, "on")
                        ...
                        //*/ hct.huangfei, 20201103. patch ALPS05246069.
