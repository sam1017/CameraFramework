...
public class AIComboCaptureSurface {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AIComboCaptureSurface.class.getSimpleName());
     ...
     */
    public AIComboCaptureSurface() {
        LogHelper.d(TAG, "[AIComboCaptureSurface]Construct");
    ...
    public void releaseCaptureSurface() {
        LogHelper.d(TAG, "[releaseCaptureSurface], release mCaptureImageReader = " + mCaptureImageReader);
        synchronized (mImageReaderSync) {
            if (mCaptureImageReader != null) {
