...
public class MonoRestriction {
    // This key must same as every setting keys define, otherwise will have no role about the
    // restriction.
    private static final String KEY_MONO = MonoMode.class.getName();
    ...
    static {
        sRelation.setHeaderKey(KEY_MONO);
        sRelation.setBodyKeys(KEY_CSHOT + "," /*+ KEY_FLASH + "," /*HCT.ouyang + KEY_FACE_DETECTION + ","*/ +
                ...
                KEY_SCENE_MODE + "," + KEY_COLOR_EFFECT + "," + KEY_AIS+ "," + KEY_WHITE_BALANCE + "," + KEY_TRIPLE_SWITCH);
        sRelation.addRelation(
                new Relation.Builder(KEY_MONO, "on")
