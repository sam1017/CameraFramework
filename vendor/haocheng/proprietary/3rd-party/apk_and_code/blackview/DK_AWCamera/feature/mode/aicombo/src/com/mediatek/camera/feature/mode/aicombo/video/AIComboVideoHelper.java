...
public class AIComboVideoHelper {
    private static final Tag TAG = new Tag(AIComboVideoHelper.class.getSimpleName());
    ...
    private IAIComboVideoDeviceController mCameraDevice;
     ...
     */
    public AIComboVideoHelper(ICameraContext context, IApp app, IAIComboVideoDeviceController cameraDevice,
                           Handler videoHandler) {
        LogHelper.d(TAG, "[AIComboVideoHelper]");
     ...
     */
    public IAIComboVideoDeviceController.PreviewCallback getPreviewFrameCallback() {
     ...
     * @return the result.
     */
    public IAIComboRecorder.RecorderSpec configRecorderSpec(CamcorderProfile profile, String cameraId,
                                                         CameraDeviceManagerFactory.CameraApi api
            , ISettingManager settingManager) {
        sProfile = profile;
        IAIComboRecorder.RecorderSpec recorderSpec = new IAIComboRecorder.RecorderSpec();
    ...
    private IAIComboVideoDeviceController.PreviewCallback mPreviewCallback = new
            IAIComboVideoDeviceController.PreviewCallback() {
                @Override
