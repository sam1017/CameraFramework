...
public class VolumeKeySelector extends PreferenceFragment {
    private static final LogUtil.Tag TAG
            = new LogUtil.Tag(VolumeKeySelector.class.getSimpleName());
    ...
    private Preference.OnPreferenceClickListener mOnPreferenceClickListener
            = new VolumeKeyPreferenceClickListener();
    private IVolumeKeyViewListener.OnItemClickListener mListener;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            toolbar.setTitle(getActivity().getString(R.string.volume_key_title));
        }
        addPreferencesFromResource(R.xml.volume_key_selector_preference);
     ...
     *
     * @param listener The instance of {@link IStoragePathViewListener.OnItemClickListener}.
     */
    public void setOnItemClickListener(IVolumeKeyViewListener.OnItemClickListener listener) {
        mListener = listener;
    }
    ...
    /**
     * Storage path preference click listener.
     */
    private class VolumeKeyPreferenceClickListener implements Preference.OnPreferenceClickListener {
        @Override
    ...
    private String getTitlePattern(String value) {
        if (IVolumeKeyViewListener.VOLUME_KEY_VOLUME.equals(value)) {
            return getActivity().getString(R.string.volume_key_volume);
        } else if(IVolumeKeyViewListener.VOLUME_KEY_ZOOM.equals(value)) {
            return getActivity().getString(R.string.volume_key_zoom);
        } else {
            return getActivity().getString(R.string.volume_key_capture);
        }
