...
public class PanoramaModeEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(PanoramaModeEntry.class
            .getSimpleName());
     ...
     */
    public PanoramaModeEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return PanoramaModeEntry.class.getName();
    }
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mPriority = 100;
        modeItem.mClassName = getFeatureEntryName();
        modeItem.mModeSelectedIcon = mResources.getDrawable(R.drawable.ic_panorama_mode_selected);
        modeItem.mModeUnselectedIcon = mResources.getDrawable(
                R.drawable.ic_panorama_mode_unselected);
        modeItem.mModeName = mResources.getString(mResources.getIdentifier(
            "pano_dialog_title", "string", mContext.getPackageName()));
        modeItem.mSupportedCameraIds = new String[]{"0"};
        //*/ hct.huangfei, 20201021. add  mode.
        modeItem.mTitle = mContext.getResources().getString(R.string.pano_dialog_title);
        modeItem.mMode = "Panorama";		
        //*/		
        return modeItem;
    }
