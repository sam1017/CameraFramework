...
package com.mediatek.camera.feature.mode.aiworksbokehcolor.device;
...
import com.mediatek.camera.feature.mode.aiworksbokehcolor.AiWorksBokehColorDeviceInfo;
...
class AiWorksBokehColorDevice2Controller extends Device2Controller implements
        IAiWorksBokehColorDeviceController, ICompeletedCallback,
        CaptureSurface.ImageCallback,
        ISettingManager.SettingDevice2Requester {
    private static final Tag TAG = new Tag(AiWorksBokehColorDevice2Controller.class.getSimpleName());
     ...
     */
    AiWorksBokehColorDevice2Controller(@Nonnull Activity activity, @Nonnull ICameraContext context) {
        LogHelper.d(TAG, "[AiWorksBokehColorDevice2Controller]");
        mActivity = activity;
    ...
    @Override
    public void openCamera(AiWorksBokehColorDeviceInfo info) {
    ...
    public void updatePreviewSurface(Object surfaceObject) {
        ...
        LogHelper.d(TAG, "CamAp_AiWorksBokehMode [updatePreviewSurface234] onSurfaceTextureAvailable end");
    }
    ...
    @Override
    public void takePicture(@Nonnull IAiWorksBokehColorDeviceController.CaptureDataCallback callback) {
	...
	if (mPreviewReader == null) {
            LogHelper.e(TAG, "[configureSession] mPreviewReader null not return");
	    return;
	}
    ...
    private void configSettingsByStage2() {
        ...
        //Relation relation = AiWorksBokehColorRestriction.getRestriction().getRelation("on", true);
