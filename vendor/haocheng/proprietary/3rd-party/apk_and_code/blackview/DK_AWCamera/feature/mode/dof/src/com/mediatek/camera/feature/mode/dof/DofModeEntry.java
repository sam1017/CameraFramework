...
public class DofModeEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(DofModeEntry.class
            .getSimpleName());
     ...
     */
    public DofModeEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraDeviceManagerFactory.CameraApi currentCameraApi,
                             Activity activity) {
        LogHelper.i(TAG, "[bokeh_key] : " + CameraUtil.getAppVersionLevel());
        if((CameraUtil.getAppVersionLevel() == MTK_CAMERA_APP_VERSION_FIVE)
    ...
    public String getFeatureEntryName() {
        return DofModeEntry.class.getName();
    }
    ...
    public IAppUi.ModeItem getModeItem() {
        ...
        modeItem.mPriority = 90;
        modeItem.mClassName = getFeatureEntryName();
        modeItem.mModeSelectedIcon = mResources.getDrawable
                (R.drawable.ic_singlebokeh_mode_selected);
        modeItem.mModeUnselectedIcon = mResources.getDrawable
                (R.drawable.ic_singlebokeh_mode_unselected);
        modeItem.mModeName = "Bokeh";
