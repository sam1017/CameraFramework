...
public class AiWorksBokehColorEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AiWorksBokehColorEntry.class.getSimpleName());
    private static final String MODE_ITEM_TYPE = "Picture";

    public static final int MODE_ITEM_PRIORITY = 145;
     ...
     */
    public AiWorksBokehColorEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return AiWorksBokehColorEntry.class.getName();
    }
    ...
    public Object createInstance() {
        return new AiWorksBokehColorMode();
    }
    ...
    public ModeItem getModeItem() {
        ...
        modeItem.mMode = "AiWorksBokehColor";
        modeItem.mTitle = mContext.getResources().getString(R.string.accessibility_switch_to_aiworkbokehcolor);
        modeItem.mModeName = mContext.getString(R.string.accessibility_switch_to_aiworkbokehcolor);
        return modeItem;
    }
}
