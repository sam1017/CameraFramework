...
public class LongExposureView extends View {
    ...
    private LongExposureView.LongExposureViewState mState = LongExposureView
            .LongExposureViewState.STATE_FINISH;
    //bv wuyonglin modify for long exposure take picture button position 20200219 start
    ...
    private static final int sShutterWidth = 70;
    //bv wuyonglin modify for long exposure take picture button position 20200219 end
    ...
    //add by huangfei for bokeh state start
    public LongExposureViewState getState(){
        return mState;
    }
    //add by huangfei for bokeh state end    
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        //bv wuyonglin detele for long exposure take picture button position 20200219 start
        //mRingWidth = width / 40f;
        //bv wuyonglin detele for long exposure take picture button position 20200219 end
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            //bv wuyonglin modify for long exposure take picture button position 20200225 start
            //mRingWidth = 40f;
            mRingWidth = 5f;
            //bv wuyonglin modify for long exposure take picture button position 20200225 end
