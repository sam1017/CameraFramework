...
public class HctFaceBeautyRestriction {
    // This key must same as every setting keys define, otherwise will have no role about the
    // restriction.
    private static final String KEY_HCTFACEBEAUTY= HctFaceBeautyMode.class.getName();
    ...
    static {
        sRelation.setHeaderKey(KEY_HCTFACEBEAUTY);
        sRelation.setBodyKeys(KEY_CSHOT + "," + KEY_FACE_DETECTION + "," +
                KEY_HDR + "," + KEY_ZSD + "," + KEY_DNG + "," + KEY_SELF_TIMER + "," +
                KEY_SCENE_MODE + "," +
                KEY_COLOR_EFFECT+ "," +
                KEY_WHITE_BALANCE + "," + KEY_TRIPLE_SWITCH);
        sRelation.addRelation(
                new Relation.Builder(KEY_HCTFACEBEAUTY, "on")
