...
public class AIBokehVideoModeEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AIBokehVideoModeEntry.class
            .getSimpleName());
     ...
     */
    public AIBokehVideoModeEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return AIBokehVideoModeEntry.class.getName();
    }
    ...
    public IAppUi.ModeItem getModeItem() {
        ...
        modeItem.mPriority = 25;
        modeItem.mShutterIcon = null;
        modeItem.mClassName = getFeatureEntryName();
        modeItem.mModeSelectedIcon = mResources.getDrawable(R.drawable.ic_ai_bokeh_mode_selected);
        modeItem.mModeUnselectedIcon = mResources.getDrawable(R.drawable.ic_ai_bokeh_mode_unselected);
        modeItem.mModeName = mResources.getString(R.string.aibokeh_mode_name);
