...
/**
 * This class is for fill light feature entry.
 */

public class GridlinesEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(GridlinesEntry.class.getSimpleName());
     ...
     */
    public GridlinesEntry(Context context, Resources resources) {
    ...
    public boolean isSupport(CameraApi currentCameraApi, Activity activity) {
        return Config.isGridlinesSupport(activity);
    }

    @Override
    public String getFeatureEntryName() {
        return GridlinesEntry.class.getName();
    }
