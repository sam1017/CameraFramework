...
public class ProRestriction {
    ...
    static {
        sRelation.setHeaderKey(KEY_PRO);
        sRelation.setBodyKeys(KEY_CSHOT + "," + KEY_FLASH + "," + KEY_FACE_DETECTION + "," +
                KEY_HDR + "," + "," + KEY_DNG + "," + /*KEY_SELF_TIMER + "," +*/
                KEY_CAMERA_SWITCHER + "," + KEY_WIDE_ANGLE_SWITCHER + "," + KEY_SCENE_MODE + "," + KEY_COLOR_EFFECT + "," +
                KEY_WHITE_BALANCE + "," + KEY_SCENE_MODE + "," + KEY_AIS + "," + KEY_ISO + "," +
                KEY_ZSD+ "," +KEY_EXPOSURE + "," + KEY_GRIDLINES + "," + KEY_TRIPLE_SWITCH);
        sRelation.addRelation(
                new Relation.Builder(KEY_PRO, "on")
                        ...
                        .addBody(KEY_ISO, "0", "0")
                        .addBody(KEY_ZSD, "on", "on") //HCT.ouyang iso setting invalid
                        .addBody(KEY_EXPOSURE, "0", "0")
                        .addBody(KEY_GRIDLINES, "0", "0")
