...
/**
 * Define the interaction apis between {@link HctBokehMode} and Camera Device,
 ...
 */
public interface IHctBokehDeviceController {
     ...
     */
    void openCamera(HctBokehDeviceInfo info);
     ...
     */
    void takePicture(@Nonnull IHctBokehDeviceController.CaptureDataCallback callback);
