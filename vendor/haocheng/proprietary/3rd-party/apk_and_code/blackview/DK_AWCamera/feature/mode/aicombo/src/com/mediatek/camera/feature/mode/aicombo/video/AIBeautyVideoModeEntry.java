...
public class AIBeautyVideoModeEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AIBeautyVideoModeEntry.class
            .getSimpleName());
     ...
     */
    public AIBeautyVideoModeEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return AIBeautyVideoModeEntry.class.getName();
    }
    ...
    public IAppUi.ModeItem getModeItem() {
        ...
        modeItem.mModeSelectedIcon = mResources.getDrawable(R.drawable.ic_ai_beauty_mode_selected);
        modeItem.mModeUnselectedIcon = mResources.getDrawable(R.drawable.ic_ai_beauty_mode_unselected);
        modeItem.mModeName = mResources.getString(R.string.aibeauty_mode_name);
