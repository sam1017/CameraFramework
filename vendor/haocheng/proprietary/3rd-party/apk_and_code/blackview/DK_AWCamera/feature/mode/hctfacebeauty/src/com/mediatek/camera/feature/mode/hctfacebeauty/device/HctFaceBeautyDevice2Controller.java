...
import com.mediatek.camera.feature.mode.hctfacebeauty.HctFaceBeautyRestriction;
...
class HctFaceBeautyDevice2Controller extends Device2Controller implements
        IHctFaceBeautyDeviceController, ICompeletedCallback,
        CaptureSurface.ImageCallback,
        ISettingManager.SettingDevice2Requester {
    private static final Tag TAG = new Tag(HctFaceBeautyDevice2Controller.class.getSimpleName());
    ...
    private  int mLightenValue = 0;
    private int mRuddyValue;
    private int mSlenderValue;
     ...
     */
    HctFaceBeautyDevice2Controller(@Nonnull Activity activity, @Nonnull ICameraContext context) {
        LogHelper.d(TAG, "[HctFaceBeautyDevice2Controller]");
        mActivity = activity;
    ...
    @Override
    public void openCamera(HctFaceBeautyDeviceInfo info) {
        synchronized (CameraApplication.class) {
        CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.openCamera", true, true);
        ...
        CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.openCamera", false, true);
        }
    }
    ...
    @Override
    public void takePicture(@Nonnull IHctFaceBeautyDeviceController.CaptureDataCallback callback) {
        LogHelper.i(TAG, "[takePicture] mSession= " + mSession);
        CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.takePicture", true, true);
        ...
        CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.takePicture", false, true);
    }
    ...
    public void closeCamera(boolean sync) {
        ...
        CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.closeCamera", true, true);
        ...
        mCurrentCameraId = null;
        CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.closeCamera", false, true);
    ...
    public void onPictureCallback(byte[] data,
        ...
        if (mCaptureDataCallback != null) {
            ...
            if (ThumbnailHelper.isPostViewSupported()) {
                ...
                if(!Config.updateThumbnailWithoutExif(mActivity)){
                    info.needUpdateThumbnail = false;
                }
            ...
            if (ThumbnailHelper.CAPTURE_TYPE_THUMBNAIL.equalsIgnoreCase(captureType)) {
                CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.onPostViewCallback", true, true);
                ...
                CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.onPostViewCallback", false, true);
            } else {
                CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.onJpegCallback", true, true);
                mCaptureDataCallback.onDataReceived(info);
                CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.onJpegCallback", false, true);
    ...
    private void repeatingPreview(boolean needConfigBuiler) {
        ...
        CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.repeatingPreview", true, true);
        if (mSession != null && mCamera2Proxy != null) {
            try {
                if (needConfigBuiler) {
        ...
        CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.repeatingPreview", false, true);
    }
    ...
    private final CaptureCallback mCaptureCallback = new CaptureCallback() {
        ...
        public void onCaptureProgressed(CameraCaptureSession session, CaptureRequest request,
            ...
            if (CameraUtil.isStillCaptureTemplate(request)
                ...
                CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.onP2Done", true, true);
                LogHelper.d(TAG, "[onCaptureProgressed] P2done comes, frame: " + num);
                updateCameraState(CameraState.CAMERA_OPENED);
                mModeDeviceCallback.onPreviewCallback(null, 0);
                CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.onP2Done", false, true);
            }
        }
        ...
        public void onCaptureCompleted(@Nonnull CameraCaptureSession session,
            ...
            if (CameraUtil.isStillCaptureTemplate(result)) {
                ...
                CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.onFirstFrameArrived", true, true);
                mFirstFrameArrived = true;
                updateCameraState(CameraState.CAMERA_OPENED);
                mModeDeviceCallback.onPreviewCallback(null, 0);
                mICameraContext.getSoundPlayback().init();
                CameraSysTrace.onEventSystrace("HctFaceBeautyDevice.onFirstFrameArrived", false, true);
            }
    ...
    @Override
    public void setBeautyParameter(int smooth,int lighten,int ruddy,int slender) {
        //mDataStore.setValue("pi_facebeauty_progress",progress+"",mDataStore.getGlobalScope(),false);
        mSmoothValue = smooth;
        mLightenValue = lighten;
        mRuddyValue = ruddy;
        mSlenderValue = slender;
    ...
    private void setBeautyParameter(CaptureRequest.Builder builder){
        CaptureRequest.Key<int[]> mBeautymode =  new CaptureRequest.Key<int[]>("com.mediatek.control.capture.hcttripartitealgorithmmode", int[].class);
        CaptureRequest.Key<int[]> mBeautyLevel =  new CaptureRequest.Key<int[]>("com.mediatek.control.capture.hctfacebeautyparameter", int[].class);
        BEAUTY_MODE_VALUE[0] = 32;
        BEAUTY_MODE_VALUE[1] = 64;
        BEAUTY_PARAMETER_VALUE[0] = mLightenValue;
        BEAUTY_PARAMETER_VALUE[1] = mSmoothValue;
        BEAUTY_PARAMETER_VALUE[2] = mSlenderValue;
        BEAUTY_PARAMETER_VALUE[3] = mRuddyValue;
