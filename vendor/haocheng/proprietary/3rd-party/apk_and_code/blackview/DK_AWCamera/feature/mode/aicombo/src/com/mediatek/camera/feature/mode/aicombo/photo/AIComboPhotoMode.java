...
import com.mediatek.camera.feature.mode.aicombo.photo.device.AIComboPhotoDeviceController;
import com.mediatek.camera.feature.mode.aicombo.photo.device.AIComboPhotoDeviceControllerFactory;
import com.mediatek.camera.feature.mode.aicombo.photo.device.IAIComboPhotoDeviceController;
import com.mediatek.camera.feature.mode.aicombo.photo.device.IAIComboPhotoDeviceController.DeviceCallback;
import com.mediatek.camera.feature.mode.aicombo.photo.device.IAIComboPhotoDeviceController.PreviewSizeCallback;
 ...
 */
public class AIComboPhotoMode extends CameraModeBase
        implements CaptureDataCallback,
        DeviceCallback,
        PreviewSizeCallback,
        IMemoryManager.IMemoryListener {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AIComboPhotoMode.class.getSimpleName());
    ...
    protected IAIComboPhotoDeviceController mIDeviceController;
    ...
    public static final int ON_CAMERA_PARAMETERS_READY = 101;
    public static final int INFO_FACE_DETECTED = 102;
    public static final int ORIENTATION_CHANGED = 103;
    public static final int ON_BACK_PRESSED = 104;
    public static final int HIDE_EFFECTS_ITEM = 105;
    public static final int ON_FULL_SCREEN_CHANGED = 106;
    public static final int ON_CAMERA_CLOSED = 107;
    public static final int ON_SETTING_BUTTON_CLICK = 108;
    public static final int ON_LEAVE_FACE_BEAUTY_MODE = 109;
    public static final int ON_SELFTIMER_CAPTUEING = 110;
    public static final int IN_PICTURE_TAKEN_PROGRESS = 111;
    public static final int REMVOE_BACK_TO_NORMAL = 112;
    ...
    protected void initCameraDevice(CameraApi api) {
        mIDeviceController = AIComboPhotoDeviceControllerFactory.createDeviceController(
                mApp.getActivity(), api, mICameraContext);
    }
    ...
    public void onOrientationChanged(int orientation) {
        //mAIComboViewCtrl.onOrientationChanged(orientation);
    }
