 ...
 */
public interface IAiWorksBokehDeviceController {
     ...
     */
    void openCamera(AiWorksBokehDeviceInfo info);
     ...
     */
    void takePicture(@Nonnull IAiWorksBokehDeviceController.CaptureDataCallback callback);
