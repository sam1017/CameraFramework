...
public class PanoramaView {
    ...
    private void prepareTransformMatrix(int direction) {
        ...
        //*/ hct.huangfei, 20201021. panorama view animation position abnormal.
        if(mPreviewWidth==0||mPreviewHeight==0){
            mPreviewWidth = mScreenProgressLayout.getHeight();
            mPreviewHeight = mScreenProgressLayout.getWidth();
        }
        //*/
