...
/**
 * Define the interaction apis between {@link SuperphotoMode} and Camera Device,
 ...
 */
public interface ISuperphotoDeviceController {
     ...
     */
    void openCamera(SuperphotoDeviceInfo info);
     ...
     */
    void takePicture(@Nonnull ISuperphotoDeviceController.CaptureDataCallback callback);
