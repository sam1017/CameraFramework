...
public class WaterMarkSettingView implements ICameraSettingView {
    ...
    private OnWaterMarkViewListener mViewListener;
    private SwitchPreference mPref;
    private boolean mChecked;
    private boolean mEnabled;

    /**
     * Listener with WaterMark view.
     */
    interface OnWaterMarkViewListener {
    ...
    public void loadView(final PreferenceFragment fragment) {
        fragment.addPreferencesFromResource(R.xml.water_mark_preference);
        mPref = (SwitchPreference) fragment.findPreference(KEY_WATERMARK);
        mPref.setRootPreference(fragment.getPreferenceScreen());
        mPref.setId(R.id.watermark_setting);
        mPref.setContentDescription(fragment.getActivity().getResources()
                .getString(R.string.water_mark_content_description));
     ...
     *
     * @param viewListener the WaterMark view listener.
     */
    public void setWaterMarkViewListener(OnWaterMarkViewListener viewListener) {
