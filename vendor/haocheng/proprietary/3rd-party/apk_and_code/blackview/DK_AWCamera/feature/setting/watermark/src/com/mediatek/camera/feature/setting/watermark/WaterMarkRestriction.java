...
public class WaterMarkRestriction {
    private static RelationGroup sRelationGroup = new RelationGroup();

    static {
        sRelationGroup.setHeaderKey("key_water_mark");
        sRelationGroup.setBodyKeys("key_continuous_shot");
        sRelationGroup.addRelation(
                new Relation.Builder("key_water_mark", "on")
        ...
        sRelationGroup.addRelation(
                new Relation.Builder("key_water_mark", "off")
                        .addBody("key_continuous_shot", "on", "on,off")
                        .build());
