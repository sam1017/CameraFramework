...
public class AiWorksBokehModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AiWorksBokehModeHelper.class.getSimpleName());
     ...
     */
    public AiWorksBokehModeHelper(ICameraContext cameraContext) {
