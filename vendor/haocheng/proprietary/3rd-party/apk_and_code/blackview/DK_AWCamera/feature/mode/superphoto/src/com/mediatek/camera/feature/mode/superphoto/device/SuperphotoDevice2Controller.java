...
package com.mediatek.camera.feature.mode.superphoto.device;
...
import com.mediatek.camera.feature.mode.superphoto.SuperphotoDeviceInfo;
...
import com.mediatek.camera.feature.mode.superphoto.SuperphotoRestriction;
...
class SuperphotoDevice2Controller extends Device2Controller implements ISuperphotoDeviceController, ICompeletedCallback,
        CaptureSurface.ImageCallback,
        ISettingManager.SettingDevice2Requester {
    private static final Tag TAG = new Tag(SuperphotoDevice2Controller.class.getSimpleName());
     ...
     */
    SuperphotoDevice2Controller(@Nonnull Activity activity, @Nonnull ICameraContext context) {
        LogHelper.d(TAG, "[SuperphotoDevice2Controller]");
        mActivity = activity;
    ...
    @Override
    public void openCamera(SuperphotoDeviceInfo info) {
        CameraSysTrace.onEventSystrace("SuperphotoDevice.openCamera", true, true);
        ...
        CameraSysTrace.onEventSystrace("SuperphotoDevice.openCamera", false, true);
    }
    ...
    @Override
    public void takePicture(@Nonnull ISuperphotoDeviceController.CaptureDataCallback callback) {
        LogHelper.i(TAG, "[takePicture] mSession= " + mSession);
        CameraSysTrace.onEventSystrace("SuperphotoDevice.takePicture", true, true);
        ...
        CameraSysTrace.onEventSystrace("SuperphotoDevice.takePicture", false, true);
    }
    ...
    public void closeCamera(boolean sync) {
        ...
        CameraSysTrace.onEventSystrace("SuperphotoDevice.closeCamera", true, true);
        ...
        mCurrentCameraId = null;
        CameraSysTrace.onEventSystrace("SuperphotoDevice.closeCamera", false, true);
...
*/
            ...
            if (ThumbnailHelper.FORMAT_TAG.equalsIgnoreCase(formatTag)) {
                CameraSysTrace.onEventSystrace("SuperphotoDevice.onPostViewCallback", true, true);
                mCaptureDataCallback.onPostViewCallback(data);
                CameraSysTrace.onEventSystrace("SuperphotoDevice.onPostViewCallback", false, true);
            } else {
                CameraSysTrace.onEventSystrace("SuperphotoDevice.onJpegCallback", true, true);
                mCaptureDataCallback.onDataReceived(info);
                CameraSysTrace.onEventSystrace("SuperphotoDevice.onJpegCallback", false, true);
    ...
    private void repeatingPreview(boolean needConfigBuiler) {
        ...
        CameraSysTrace.onEventSystrace("SuperphotoDevice.repeatingPreview", true, true);
        if (mSession != null && mCamera2Proxy != null) {
            try {
                if (needConfigBuiler) {
        ...
        CameraSysTrace.onEventSystrace("SuperphotoDevice.repeatingPreview", false, true);
    }
    ...
    private final CaptureCallback mCaptureCallback = new CaptureCallback() {
        ...
        public void onCaptureProgressed(CameraCaptureSession session, CaptureRequest request,
            ...
            if (CameraUtil.isStillCaptureTemplate(request)
                ...
                CameraSysTrace.onEventSystrace("SuperphotoDevice.onP2Done", true, true);
                LogHelper.d(TAG, "[onCaptureProgressed] P2done comes, frame: " + num);
                updateCameraState(CameraState.CAMERA_OPENED);
                mModeDeviceCallback.onPreviewCallback(null, 0);
                CameraSysTrace.onEventSystrace("SuperphotoDevice.onP2Done", false, true);
            }
        }
        ...
        public void onCaptureCompleted(@Nonnull CameraCaptureSession session,
            ...
            if (CameraUtil.isStillCaptureTemplate(result)) {
                ...
                CameraSysTrace.onEventSystrace("SuperphotoDevice.onFirstFrameArrived", true, true);
                mFirstFrameArrived = true;
                updateCameraState(CameraState.CAMERA_OPENED);
                mModeDeviceCallback.onPreviewCallback(null, 0);
                mICameraContext.getSoundPlayback().init();
                CameraSysTrace.onEventSystrace("SuperphotoDevice.onFirstFrameArrived", false, true);
            }
