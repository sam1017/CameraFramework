...
public class AiworksFaceBeautyModeHelper {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AiworksFaceBeautyModeHelper.class.getSimpleName());
     ...
     */
    public AiworksFaceBeautyModeHelper(ICameraContext cameraContext) {
