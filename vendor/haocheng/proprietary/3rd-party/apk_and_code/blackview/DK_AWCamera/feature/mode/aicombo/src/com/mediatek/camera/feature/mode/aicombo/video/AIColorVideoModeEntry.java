...
public class AIColorVideoModeEntry extends FeatureEntryBase {
    private static final LogUtil.Tag TAG = new LogUtil.Tag(AIColorVideoModeEntry.class
            .getSimpleName());
     ...
     */
    public AIColorVideoModeEntry(Context context, Resources resources) {
    ...
    public String getFeatureEntryName() {
        return AIColorVideoModeEntry.class.getName();
    }
    ...
    public IAppUi.ModeItem getModeItem() {
        ...
        modeItem.mModeSelectedIcon = mResources.getDrawable(R.drawable.ic_ai_color_mode_selected);
        modeItem.mModeUnselectedIcon = mResources.getDrawable(R.drawable.ic_ai_color_mode_unselected);
        modeItem.mModeName = mResources.getString(R.string.aicolor_mode_name);
