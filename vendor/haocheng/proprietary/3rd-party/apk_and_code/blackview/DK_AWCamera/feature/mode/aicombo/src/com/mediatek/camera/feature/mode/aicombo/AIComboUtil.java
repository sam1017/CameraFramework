...
package com.mediatek.camera.feature.mode.aicombo;
 ...
 */
public final class AIComboUtil {
    private static final Tag TAG = new Tag(AIComboUtil.class.getSimpleName());
    ...
    public static int calculateRotation(boolean isFrontCamera, int sensorOrientation) {
        int orientation = isFrontCamera ? 270 - sensorOrientation: 90 + sensorOrientation;
        if (orientation >= 360) {
            orientation -= 360;
