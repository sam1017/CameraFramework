...
class FocusRestriction {
    ...
    static {
        ...
        sRelation.setBodyKeys("key_picture_size");	// bv wuyonglin add for PictureSize quickSwitch 20191224
    ...
    static {
        ...
        sAfLockRelationGroup.setBodyKeys("key_picture_size");	//bv wuyonglin add for PictureSize quickSwitch 20191224
    ...
    static {
        ...
        sAeAfLockRelationGroup.setBodyKeys("key_picture_size");	//bv wuyonglin add for PictureSize quickSwitch 20191224
