...
public class CameraAperture extends RelativeLayout implements OnSeekBarChangeListener, ApertureView.ApertureChanged {
    ...
    public CameraAperture(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView(Context context) throws Exception {
        ...
        mFilterSeekBar = (FilterSeekBar) LayoutInflater.from(context).inflate(R.layout.bokeh_seekbar, this, false);//new FilterSeekBar(context);
        ...
        mFilterSeekBar2 = (FilterSeekBar) LayoutInflater.from(context).inflate(R.layout.bokeh_seekbar, this, false);
