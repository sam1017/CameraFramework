...
/**
 * Define the interaction apis between {@link MonoMode} and Camera Device,
 ...
 */
public interface IMonoDeviceController {
     ...
     */
    void openCamera(MonoDeviceInfo info);
     ...
     */
    void takePicture(@Nonnull IMonoDeviceController.CaptureDataCallback callback);
