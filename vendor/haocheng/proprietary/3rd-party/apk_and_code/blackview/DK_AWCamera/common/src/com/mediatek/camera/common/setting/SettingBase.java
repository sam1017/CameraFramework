...
public abstract class SettingBase implements ICameraSetting {
    ...
    private static final LogUtil.Tag TAG =
            new LogUtil.Tag(SettingBase.class.getSimpleName());
    /**
    ...
    public void overrideValues(@Nonnull String headerKey, String currentValue,
        ...
        synchronized (this) {
            ...
            if (currentValue == null && supportValues == null) {
                ...
                if ("key_flash".equals(getKey()) && "key_focus".equals(headerKey)) {
                LogHelper.d(TAG, "[overrideValues] key_focus flash return");
                    return;
                }
    ...
    public String getStoreScopeByModeKey(String modeKey) {
        return mDataStore.getCameraScopeByModeKey(Integer.parseInt(mSettingController.getCameraId()), modeKey);
    }

    public String getStoreScopeByModeType(ICameraMode.ModeType mModeType) {
        return mDataStore.getStoreScopeByModeType(Integer.parseInt(mSettingController.getCameraId()), mModeType);
    }
    /**
