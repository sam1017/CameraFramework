...
public class DataStore {
    ...
    public String getCameraScopeByModeKey(int cameraId, String modeKey) {
        return PREFIX_CAMERA_SCOPE + modeKey+ "_" + cameraId;
    }

   public String getStoreScopeByModeType(int cameraId, ICameraMode.ModeType mModeType) {
        return PREFIX_CAMERA_SCOPE + mModeType+ "_" + cameraId;
    }
    /**
