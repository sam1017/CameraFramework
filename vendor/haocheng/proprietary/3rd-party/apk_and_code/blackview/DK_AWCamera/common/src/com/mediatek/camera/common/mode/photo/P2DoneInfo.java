...
public class P2DoneInfo {
    ...
    public static boolean enableP2Done(CaptureRequest.Builder builder) {
        if(mKeyP2NotificationRequest == null){
            LogHelper.d(TAG, "[enableP2Done] return false");
            return false;
        }
        if (mIsSupport) {
    ...
    public static boolean checkP2DoneResult(CaptureResult result) {
        if(mKeyP2NotificationResult==null){
            LogHelper.d(TAG, "[checkP2DoneResult] return false");
            return false;
        }
        if (mIsSupport) {
