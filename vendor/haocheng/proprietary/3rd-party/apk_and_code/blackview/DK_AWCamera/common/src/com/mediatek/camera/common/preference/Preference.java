...
public class Preference extends android.preference.Preference {
    ...
    public Preference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setLayoutResource(R.layout.bv_preference);
    ...
    protected View onCreateView(ViewGroup parent) {
         ...
         if(CameraUtil.isRTL){
             righticon.setImageDrawable(mContext.getDrawable(R.drawable.setting_more_indicator_rtl));
         }else{
             righticon.setImageDrawable(mContext.getDrawable(R.drawable.setting_more_indicator));
         }
         return view;
