...
public class ClearRecentAppListOperator extends OperatorOne {
    ...
    private void operateBeforeP() {
        try {
            ...
            Pattern clearAllPattern = Pattern.compile("clear all", Pattern.CASE_INSENSITIVE);
            Utils.waitCondition(new Condition() {
                ...
                public boolean isSatisfied() {
                    ...
                    boolean clearAll =
                      Utils.scrollUpOnScreenToFind(By.text(clearAllPattern)) != null;
                    if (clearAll) {
                        return true;
                    }
                    return false;
            ...
            // if clear all
            // Click clear all
            UiObject2 clear = Utils.getUiDevice().findObject(By.text(clearAllPattern));
            ...
            // Wait done
            Utils.assertNoObject(By.text(clearAllPattern));
    ...
    private void operateOnP() {
        try {
            ...
            Utils.waitCondition(new Condition() {
                ...
                public boolean isSatisfied() {
                    boolean clearAll =
                      Utils.scrollLeftOnScreenToFind(By.text(clearAllPattern)) != null;
                    if (clearAll) {
                        return true;
                    }
                    return false;
