...
static uint32_t __unused pixel_width_array[PIXEL_ARRAY_SIZE]  = {2832,3456,3264, 3840,4032,4000,4608,4928,4160, 4864,5184,4608,5376,5664,5312, 6080,5696,6544,6944,8000,9216,9792};
static uint32_t __unused pixel_height_array[PIXEL_ARRAY_SIZE] =  {2832,3456,2448, 2160,2016,3000,2592,2464,3120, 2736,2592,3456,3024,2832,3984, 3424,4272,3681,3472,6000,5184,4896};
...
ssize_t Camera3Device::getJpegBufferSize(uint32_t width, uint32_t height) const {
    ...
    if (jpegBufferSize > maxJpegBufferSize) {
        ...
        //modify by huangfei for add pixel start
        ...
        //modify by huangfei for add pixel end
    }
